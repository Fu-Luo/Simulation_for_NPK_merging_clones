...
%25% clones have slow dying cells, out of these clones 5% cell die each round
...
if mergingevent(1,1)>0
            %check 5%largest clones for merging event
       outputmatrix(testcount,1)=size(mergingevent,1)/sum(clonesizes>100);
       outputmatrix(testcount,2)=size(mergingevent,1);
       outputmatrix(testcount,3)=sum(clonesizes>100);
